...
// Map Rendering: Write new mapboxgl.Map(...)
...
async function fetchGeocodingData(query) {
    // encodeURIComponentbox Geocoding endpoint with limit and autocomplete params
    const endpoint = `https://api.mapbox.com/geocoding/v5/mapbox.places/${query}.json?access_token=${MAPBOX_TOKEN}&autocomplete=true&limit=10`;
